...
@section('content')
    <div class="breadcrumb-area text-center shadow dark text-light bg-cover"
        style="background-image: url('{{ $background != null && $background->show_in == 'Tentang Kami' && $background->about_in == 'Struktur Organisasi' ? asset('storage/'. $background->image) : asset('assets-home/img/default-bg.png') }}');">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="work-process-items features-content">
                <div class="text-center">
                    @if ($imageStructure)
                        <img src="{{ asset('storage/'. $imageStructure->image) }}" alt="Struktur Organisasi Hummatech" />
                    @else
