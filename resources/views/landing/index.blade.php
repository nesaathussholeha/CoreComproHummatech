                ...
                <div class="uk-container">
                    <div class="uk-grid-large uk-flex-middle" data-uk-grid>
                            ...
                            <div class="uk-grid-medium uk-child-width-1-3@m uk-child-width-1-2@s uk-margin-medium-top uk-visible@s"
                                    ...
                                    <div
                                        ...
                                        <div class="in-symbol-logo">
                                            <img src="assets_landing/img/in-lazy.gif"
                                                data-src="assets_landing/img/in-symbol-tesla.svg" alt="ticker"
                                ...
                                <div>
                                    <div
                                        ...
                                        <div class="in-symbol-logo">
                                            <img src="assets_landing/img/in-lazy.gif"
                                                data-src="assets_landing/img/in-symbol-google.svg"
                                ...
                                <div class="uk-visible@m">
                                    <div
                                        ...
                                        <div class="in-symbol-logo">
                                            <img src="assets_landing/img/in-lazy.gif"
                                                data-src="assets_landing/img/in-symbol-apple.svg" alt="ticker"
                                                width="28" height="28" data-uk-img>
                                        </div>
                                        <div class="in-price up">
                        ...
                        <div class="in-slide-img">
                            <img src="{{ asset('assets_landing/img/in-lazy.gif') }}"
                                data-src="{{ asset('assets_landing/img/in-equity-slide-1.png') }}"
            ...
            <li class="uk-flex uk-flex-middle">
                <div class="uk-container">
                    <div class="uk-grid-large uk-flex-middle" data-uk-grid>
                            ...
                            <div class="uk-grid-medium uk-child-width-1-3@m uk-child-width-1-2@s uk-margin-medium-top uk-visible@s"
                                ...
                                <div>
                                    <div
                                        class="uk-card uk-card-small uk-card-secondary uk-card-body uk-border-rounded uk-flex uk-flex-middle">
                                        <div class="in-symbol-logo">
                                            <img src="img/in-lazy.gif" data-src="img/in-symbol-mcdonalds.svg"
                                                alt="ticker" width="28" height="28" data-uk-img>
                                        </div>
                                        <div class="in-price down">
                                ...
                                <div>
                                    <div
                                        class="uk-card uk-card-small uk-card-secondary uk-card-body uk-border-rounded uk-flex uk-flex-middle">
                                        <div class="in-symbol-logo">
                                            <img src="img/in-lazy.gif" data-src="img/in-symbol-amazon.svg"
                                                alt="ticker" width="28" height="28" data-uk-img>
                                        </div>
                                        <div class="in-price up">
                                ...
                                <div class="uk-visible@m">
                                    <div
                                        class="uk-card uk-card-small uk-card-secondary uk-card-body uk-border-rounded uk-flex uk-flex-middle">
                                        <div class="in-symbol-logo">
                                            <img src="img/in-lazy.gif" data-src="img/in-symbol-microsoft.svg"
                                                alt="ticker" width="28" height="28" data-uk-img>
                                        </div>
                                        <div class="in-price down">
                        ...
                        <div class="in-slide-img">
                            <img src="assets_landing/img/in-lazy.gif"
                                data-src="assets_landing/img/in-equity-slide-2.png" alt="image-slide"
...
<div class="uk-section in-equity-2 uk-background-contain uk-background-center"
    data-src="img/in-equity-2-bg.png" data-uk-img>
    <div class="uk-container uk-margin-top">
        <div class="uk-grid uk-flex uk-flex-center">
            ...
            <div class="uk-width-3-4@m uk-margin-medium-top">
                <img class="uk-align-center" src="img/in-lazy.gif" data-src="img/in-equity-2-img.png"
                ...
                <div class="uk-grid uk-child-width-1-4@m uk-child-width-1-4@s uk-text-center in-feature-box"
                    ...
                    <a href="#">
                        <span class="in-icon-wrap">
                            <img src="img/in-lazy.gif" data-src="img/in-equity-2-icon-1.svg" alt="icon-1"
                    ...
                    <a href="#">
                        <span class="in-icon-wrap">
                            <img src="img/in-lazy.gif" data-src="img/in-equity-2-icon-2.svg" alt="icon-2"
                    ...
                    <a href="#">
                        <span class="in-icon-wrap">
                            <img src="img/in-lazy.gif" data-src="img/in-equity-2-icon-3.svg" alt="icon-3"
                    ...
                    <a href="#">
                        <span class="in-icon-wrap">
                            <img src="img/in-lazy.gif" data-src="img/in-equity-2-icon-4.svg" alt="icon-4"
                                width="42" height="42" data-uk-img>
                        </span>
        ...
        <div class="uk-grid uk-child-width-1-2@m in-testimonial-2" data-uk-grid>
            ...
            <div>
                <div class="uk-background-contain uk-background-top-left"
                    data-src="img/in-equity-4-blob-1.svg" data-uk-img>
                    <div class="uk-flex uk-flex-middle">
            ...
            <div>
                <div class="uk-background-contain uk-background-top-left"
                    data-src="img/in-equity-4-blob-2.svg" data-uk-img>
                    <div class="uk-flex uk-flex-middle">
                        <div class="uk-margin-right">
                            <div class="uk-background-primary uk-border-pill">
                                <img class="uk-align-center uk-border-pill" src="img/in-lazy.gif"
        ...
        <div class="uk-grid uk-flex uk-flex-center">
            ...
            <div class="uk-width-3-4@m uk-margin-medium-top">
                <div class="uk-flex uk-flex-center uk-flex-middle button-app">
                    ...
                    <div class="uk-margin-right">
                        <a href="#"><img src="img/in-lazy.gif" data-src="img/in-app-store.svg"
                                alt="app-store" width="120" height="40" data-uk-img></a>
                    </div>
                    <div>
