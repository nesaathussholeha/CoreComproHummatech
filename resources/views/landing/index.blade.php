                ...
                <div class="uk-container">
                    <div class="uk-grid-large uk-flex-middle" data-uk-grid>
                        <div class="uk-width-1-2@s in-slide-text">
                            <h1 class="uk-heading-small"><span
                                    class="in-highlight">Maju Bersama Berkembang Bersama</span></h1>
                        ...
                        <div class="in-slide-img">
                            <img src="{{ asset('assets_landing/img/in-lazy.gif') }}"
                                ...
                                alt="image-slide" width="500" height="746" data-uk-img>
                        </div>
                    </div>
                </div>
            </li>
    ...
    <div class="uk-container uk-margin-large-bottom">
        <div class="uk-grid uk-flex uk-flex-middle">
            <div class="uk-width-expand@m">
                <h2 class="uk-margin-small-bottom"><span
                        class="in-highlight">Menghadirkan Solusi Terintegrasi untuk Masa Digital</span></h2>
                <p class="uk-margin-top uk-text-warning">Kini Hummatech bertransformasi menjadi perusahaan yang mampu menjawab tantangan di era revolusi industri 4.0 dengan menciptakan produk berbasis
