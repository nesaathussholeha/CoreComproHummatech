...
<div class="d-flex justify-content-between mb-4 mt-">
    <div class="">
        <h4>
            {{ $sale->name }}
    ...
    <div class="">
        <a href="/sale" class="text-white btn" style="background-color: #1B3061">
            Kembali
        </a>
    </div>
</div>
        ...
        <div id="carousel" class="carousel" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <canvas id="pdf-canvas" class="d-block w-100" data-file="{{ asset('storage/' . $sale->proposal) }}"></canvas>
