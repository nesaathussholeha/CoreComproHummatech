...
let target = document.querySelector("#income-chart");
if (target) {
    var expensesEl = new ApexCharts(target, expensesOption);
    expensesEl.render();
}
    ...
    series: [
        {
            name: "Desktops",
            data: [
                50, 50, 50, 25, 25, 25, 2, 2, 2, 25, 25, 25, 62, 62, 62, 35, 35,
                35, 66, 66,
            ],
        },
    ],
...
target = document.querySelector("#expense-chart");
if (target) {
...
target = document.querySelector("#product-chart");
...
target = document.querySelector("#sales-chart");
if (target) {
    var chart = new ApexCharts(target, options);
    chart.render();
}
...
target = document.querySelector("#sales-overview");
if (target) {
    var chart = new ApexCharts(target, options);
    chart.render();
}
...
target = document.querySelector("#Investment-chart");
if (target) {
    var chart1 = new ApexCharts(target, options1);
    chart1.render();
}
